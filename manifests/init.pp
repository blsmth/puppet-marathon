...
#
# [*authenticate*]
#   Use slave authentication to authenticate with the master
#   default: false
#
# [*auth_principal*]
#   Principal to use when authenticating with the master.  See Mesos
#   authentication and ACL's for more info.
#
